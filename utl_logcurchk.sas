...
Sample call         : %utl_logcurchk(c:/log/sample.log,c:/log/sampleChk.txt)                                                                               
...
Files                                                                                                                                                      
  ...
  Input             : c:/log/sample.log                                                                                                                    
                                                                                                                                                           
  Output            : c:/txt/sample.txt                                                                                                                    
...
%macro utl_logcurchk;                                                                                                                                      
    ...
    filename pwd ".";                                                                                                                                      
    %let pwd = %sysfunc(pathname(pwd));                                                                                                                    
                                                                                                                                                           
    %put xxxxxxxxxxxx &=pwd xxxxxxxxxxxxxxxxx;                                                                                                             
                                                                                                                                                           
    %let loginp = c:\utl\pgm.log;                                                                                                                          
                                                                                                                                                           
    %put xxxxxxxxxxxxxxxxx&loginp xxxxxxxxxxxxxxxxxx;                                                                                                      
