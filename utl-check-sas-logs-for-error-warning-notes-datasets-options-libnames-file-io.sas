%let pgm=utl-check-sas-logs-for-error-warning-notes-datasets-options-libnames-file-io;
...
----------------------------------------------------------------------------------------------------------------------
LOG        c:\utl\pgm.log                     * The log is saved in the present working directory
SCRUB_TIME 15:41 Saturday, October 16, 2021   * When the log was analyzed;
...
----------------------------------------------------------------------------------------------------------------------
ERROR      ERROR: Physical file does not exist, j:\not_on_drive;.
----------------------------------------------------------------------------------------------------------------------
WARNING    WARNING: The data set WORK.PROBLEMS may be incomplete.
           When this step was stopped there were 0 observations and 8 variables.
WARNING    WARNING: Data set WORK.PROBLEMS was not replaced because this step was stopped.
----------------------------------------------------------------------------------------------------------------------
NOTES      NOTE: Division by zero detected during the compilation phase, detected at line 31749 column 6.
NOTES      NOTE: Variable NOT_IN_INPUT is uninitialized.
NOTES      NOTE: The data set WORK.X has 0 observations and 0 variables.
NOTES      NOTE: The SAS System stopped processing this step because of errors.
----------------------------------------------------------------------------------------------------------------------
DATASETS   NOTE: Table SASUSER.USR created, with 19 rows and 5 columns.
DATASETS   NOTE: The data set WORK.X has 0 observations and 0 variables.
DATASETS   NOTE: The data set WORK.HAVE has 19 observations and 5 variables.
----------------------------------------------------------------------------------------------------------------------
FILE_IO    NOTE: 19 records were written to the file "c:/utl/sample.txt".
FILE_IO    ERROR: Physical file does not exist, j:\not_on_drive;.
FILE_IO    Filename=c:\utl\sample.txt,
...
28792  data work.have;
28793    file "c:/utl/sample.txt";
28794    set sashelp.class;
28795    put (_all_) (',' $);
28796  run;

NOTE: The file "c:/utl/sample.txt" is:
      Filename=c:\utl\sample.txt,

NOTE: 19 records were written to the file "c:/utl/sample.txt".
...
28797  proc sql;
28798    create
28799       table sasuser.usr as
28800    select
28801       *
28802    from
28803       sashelp.class
28804  ;
NOTE: Table SASUSER.USR created, with 19 rows and 5 columns.

28804!  quit;

28805  data x;
28806    if _n_=0 then output;
28807  run;

NOTE: The data set WORK.X has 0 observations and 0 variables.

28807!     quit;
28808  data problems;
28809    set sashelp.class;
28810    x=NOT_IN_INPUT;
28811    y=0/0;
NOTE: Division by zero detected during the compilation phase, detected at line 28811 column 6.
28812    file "j:/not_on_drive;";
28813    put (_all_) (',' $);
28814  run;

NOTE: Variable NOT_IN_INPUT is uninitialized.
ERROR: Physical file does not exist, j:\not_on_drive;.
NOTE: The SAS System stopped processing this step because of errors.
WARNING: The data set WORK.PROBLEMS may be incomplete.  When this step was stopped there were 0 observations and 8 variables.
WARNING: Data set WORK.PROBLEMS was not replaced because this step was stopped.
28814!     quit;
